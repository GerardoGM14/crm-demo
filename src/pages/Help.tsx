  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500 mt-2">{t('help.subtitle')}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        <Card className="hover:shadow-md transition-shadow cursor-pointer border-blue-100 bg-blue-50">
          <CardContent className="flex items-center gap-4 p-6">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">{t('help.email_support')}</h3>
        ...
        <Card className="hover:shadow-md transition-shadow cursor-pointer border-green-100 bg-green-50">
          <CardContent className="flex items-center gap-4 p-6">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">{t('help.call_us')}</h3>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <MdHelpOutline /> {t('help.faq.title')}
          </CardTitle>
        </CardHeader>
